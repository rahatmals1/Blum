...
async def main():
    banner = f"""
{magenta} _____ __    _____ _____  {blue}BLUM AUTO TASK AND PLAY GAME BOT {blue}BLUM
{magenta}| __  |  |  |  |  |     | {blue}Author : {blue}RahatMals
{magenta}| __ -|  |__|  |  | | | | {blue}Telegram : {blue}https://t.me/InstantEarning169
{magenta}|_____|_____|_____|_|_|_| {blue}Note : {blue}JOIN MY TELEGRAM CHANNEL
        """
